        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Developing scalable web applications with secure backend architectures and interactive frontend experiences.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Building intelligent systems using RAG, LLMs, and data analysis to solve complex problems and derive insights.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
