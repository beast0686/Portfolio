...
export function initialFX() {
  ...
  lenis.start(); // ponytail: replaces smoother.paused(false)
  ...
  var landingText = new SplitType(
    ".landing-info h3, .landing-intro h2, .landing-intro h1", // ponytail: SplitType takes CSS selector string, not array
    {
      types: "chars,lines",
